...
1. Repositorio Git y versionado
    ...
    Dentro del repositorio GitHub, en la sección de issues estará la información sobre todos los commits realizados así como del log del proyecto (información adicional sobre mi experiencia con el proyecto trabajando en Git será tratada en la sección "Reflexión").
